...
const title = "Achieve Your Goals With CadRank";
...
const achievementList = [
    ...
    {
        count: '3084',
        desc: 'Learners Enrolled in CadRank Courses',
    },
    {
        count: '330',
...
const Achievement = () => {
    return (
        <div className="achievement-section " style={{paddingTop:"40px", paddingBottom:"40px"}}>
